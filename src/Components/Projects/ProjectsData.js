export const projects = [
    {
        ...
        difficulty:
            "Managing authentication and role-based dashboards while integrating real-time class scheduling.",
        futurePlan:
...

    {
        ...
        stack: ["React.js", "Firebase", "Tailwind CSS", "React Router"],
        difficulty:
            "Handling notification scheduling and CRUD functionality with cloud data sync.",
        futurePlan:
